...
### ✨ Características (Demasiado) Útiles
  ...
  * **Panteón de IAs Conectadas:** Hemos integrado soporte configurable para los grandes dioses de la inteligencia: **Google Gemini** (el favorito), **OpenAI ChatGPT**, y el intrigante **Perplexity**. O, por si eres un purista masoquista, puedes desactivarla por completo.
